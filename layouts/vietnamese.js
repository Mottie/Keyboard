/* Viet keyboard layouts
 * contains layout: 'viet-qwerty'
 * Vinh Can Code: tbvinh@gmail.com
 * To use:
 *  Point to this js file into your page header: <script src="layouts/viet.js" type="text/javascript"></script>
 *  Initialize the keyboard using: $('input').keyboard({ layout: 'viet-qwerty' });
 *
...
$.extend(true, $.keyboard.defaultOptions, language.viet);
...
$.keyboard.comboRegex = /([ueoaidy"\u01B0""\u01A1""\u0103""\u00E2""\u0055""\u01AF""\u01A0""\u0102""\u00C2""\u00E2""\u00F4""\u00EA""\u00C2""\u00D4""\u00CA"])([a-z,0-9])/gim;
