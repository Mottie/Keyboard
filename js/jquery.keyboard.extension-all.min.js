...
/* Mobile Themes v1.0.2 (updated 2/4/2014) */
...
function(){!0!==a.mobile_initialized&&a.mobile_setup()})},a.mobile_setup=function(){var d;d=b.extend({},c.buttonMarkup,c.buttonAction);a.$keyboard.addClass("ui-bar ui-bar-"+c.container.theme).removeClass("ui-widget ui-widget-content").find("button:not(."+a.options.css.buttonAction+")").addClass(a.modButton(c.buttonMarkup)).end().find("."+a.options.css.buttonAction).addClass(a.modButton(d)).end().find("button").removeClass("ui-corner-all ui-state-default").hover(function(){b(this).addClass("ui-btn-hover-"+
c.buttonHover.theme)},function(){b(this).removeClass("ui-btn-hover-"+c.buttonHover.theme)});a.options.css.buttonAction="ui-btn-down-"+c.buttonActive.theme;a.msie&&a.$preview[0]!==a.el&&(a.$preview.hide(),a.$keyboard.css("width",""),a.width=a.$keyboard.outerWidth(),a.$keyboard.width(a.width+parseInt(a.$preview.css("fontSize"),10)),a.$preview.width(a.width),a.$preview.show());d=a.options.position;d.of=d.of||a.$el.data("keyboardPosition")||a.$el;d.collision=a.options.usePreview?d.collision||"fit fit":
"flip flip";a.$keyboard.position(d);a.mobile_initialized=!0},a.modButton=function(a){return"ui-btn ui-btn-up-"+a.theme+" ui-btn-"+a.theme+("true"==a.shadow?" ui-shadow":"")+("true"==a.corners?" ui-btn-corner-all":"")},a.mobile_init())})}})(jQuery);
